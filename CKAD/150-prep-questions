...
```kubectl set image pod/nginx nginx=nginx:1.15-alpinekubectl describe po nginx```
...
spec:
  ...
  [Credits - Medium](https://medium.com/bb-tutorials-and-thoughts/practice-enough-with-these-questions-for-the-ckad-exam-2f42d1228552)
